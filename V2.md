...
- SyncMe Monitor remains an optional separate package (not absorbed into core host)
...
- Optional Monitor heartbeat client
...
| D005 | Monitor remains separate package | Keep core install lean; fleet UI is optional |
...
5. How much monitor-side reuse should occur without merging products?
